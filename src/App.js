...
class App extends Component {
   ...
   calculateFaceLocations = (data) => {
      const boxes = [];
      const faces = data.outputs[0].data.regions.forEach( (face, id) => {
         
         const clarifaiFace = data.outputs[0].data.regions[id].region_info.bounding_box;
   ...
   onPictureSubmit = () => {
      ...
      fetch('https://dry-dawn-98583.herokuapp.com/imageurl', {
         method: 'post',
      ...
      .then(response => { 
         if (response) {
            fetch('https://dry-dawn-98583.herokuapp.com/image', {
               method: 'put',
               headers: { 'Content-Type': 'application/json' },
               body: JSON.stringify({
